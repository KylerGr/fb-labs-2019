...
my_text = open("crypto_lab1.txt", "r+", encoding='utf-8')
...
def bi_gram_entropy(text_5):
    ...
    for i in range(count-1):
        dictionary[text_5[i] + text_5[i+1]] += 1
    for frequency in dictionary:
        dictionary[frequency] /= count - 1

    entropy = 0
    for i in dictionary:
        if dictionary[i] != 0:
            entropy -= dictionary[i] * math.log(dictionary[i], 2)
    entropy /= 2
    h = (1 - (entropy/math.log(34, 2)))
    print("Here are the sequences: " + str(dictionary))
    print("Bi gram entropy with the spaces is: " + str(entropy))
    print("Below is your H!")
    return h
...
def bi_gram_entropy_two(text_6):
    ...
    for i in array:
        for j in array:
            dictionary[i + j] = 0
    for i in range(count - 1):
        dictionary[text_6[i] + text_6[i + 1]] += 1
    for frequency in dictionary:
        dictionary[frequency] /= count - 1
    entropy = 0
    for i in dictionary:
    ...
    h = (1 - (entropy / math.log(33, 2)))
    print("Here are the sequences: " + str(dictionary))
    print("Bi gram entropy without the spaces is: " + str(entropy))
    print("Below is your H!")
    return h
...
def bi_gram_entropy_3(text_7):
    ...
    for i in range(0, count - 1, 2):
        dictionary[text_7[i] + text_7[i + 1]] += 1
    for frequency in dictionary:
        dictionary[frequency] /= count // 2
    ...
    h = (1 - (entropy / math.log(34, 2)))
    print("Here are the sequences: " + str(dictionary))
    print("Bi gram entropy with the spaces and without crossing is: " + str(entropy))
    print("Below is your H!")
    return h
...
def bi_gram_entropy_4(text_8):
    ...
    for i in array:
        for j in array:
            dictionary[i + j] = 0
    for i in range(0, count - 1, 2):
        dictionary[text_8[i] + text_8[i + 1]] += 1
    for frequency in dictionary:
        dictionary[frequency] /= count // 2
    entropy = 0
    for i in dictionary:
